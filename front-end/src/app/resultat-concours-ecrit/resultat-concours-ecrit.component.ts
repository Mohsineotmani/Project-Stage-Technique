...
@Component({
  selector: 'app-resultat-concours-ecrit',
  templateUrl: './resultat-concours-ecrit.component.html',
  styleUrls: ['./resultat-concours-ecrit.component.scss']
})
export class ResultatConcoursEcritComponent implements OnInit {
  ...
  loadResults(): void {
    this.resultatConcoursService.getAllResultatsEcrit().subscribe(
      (data) => {
        this.concoursResults = data;
        this.filteredResults = data;
        console.log("##loadResults-->" , this.filteredResults);
      },
      (error) => {
