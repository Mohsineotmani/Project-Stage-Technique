...
export class EcritNotesService {
  private apiUrl = 'http://localhost:8082/api/ecrit-notes';
  ...
  publishResults(): Observable<any> {
    ...
    return this.http.post<any>('http://localhost:8082/api/ecrit-notes/publish', {}, { headers });
  }
  ...
  publishOralResults(): Observable<any> {
    ...
    return this.http.post<any>('http://localhost:8082/api/ecrit-notes/publishOralResults', {}, { headers }).pipe(
